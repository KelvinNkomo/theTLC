...
namespace Synergince {
    ...
    public partial class CourseDataSet : global::System.Data.DataSet {
        ...
        public partial class CourseDataTable : global::System.Data.TypedTableBase<CourseRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public CourseRow AddCourseRow(string CourseCode, string CourseName) {
...
namespace Synergince.CourseDataSetTableAdapters {
    ...
    public partial class CourseTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Course] WHERE (([CourseCode] = @Original_CourseCode))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Course] ([CourseCode], [CourseName]) VALUES (@CourseCode, @Cou" +
                "rseName)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Course] SET [CourseCode] = @CourseCode, [CourseName] = @CourseName " +
                "WHERE (([CourseCode] = @Original_CourseCode))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CourseCode, CourseName FROM dbo.Course";
        ...
        public virtual int Delete(string Original_CourseCode) {
        ...
        public virtual int Update(string CourseCode, string CourseName, string Original_CourseCode) {
            if ((CourseCode == null)) {
                throw new global::System.ArgumentNullException("CourseCode");
            }
            else {
            ...
            if ((Original_CourseCode == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(Original_CourseCode));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CourseName, string Original_CourseCode) {
            return this.Update(Original_CourseCode, CourseName, Original_CourseCode);
        }
    }
